...
public class Client {
	...
	public static void main(String[] args) {
		...
		if(args.length == 1)
		{
			...
			{
				System.err.println("[CLIENT]> Integer Port not provided. Default Server port will be used.");
		...
		{
			System.err.println("[CLIENT]> Not enough parameters provided. serverHost is required.");
			System.exit(-1);
		}
	...
	private static String getFileName(String content)
	{
		...
		if(filename.equals(""))
		{
			filename = "index"; //address to index.htm
		}
